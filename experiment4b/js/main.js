...
function p3_worldKeyChanged(key, clear) {
    ...
    if (clear) {
        ...
        // Create random star types
        for (let i = 0; i < NUM_STAR_TYPES; i++) {
            let star_type = new StarType();
            star_types.push(star_type);
            // Sort star types by rarity
            star_types.sort((a, b) => a.rarity - b.rarity);
        }
    }
}
